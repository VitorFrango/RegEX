...
pilAvailable = True
try:
    import PIL.Image as Image # changed from "import image", by EC [September 2022]
    import PIL.ImageTk as ImageTk # same 
except:
    pilAvailable = False
...
if __name__ == '__main__':
    win = ImageWin("My Window",1024,683)
    oImage = FileImage('/Users/ernestocosta/tmp/tartaruga.jpg')
    oImage.draw(win)
    myImage = oImage.copy()
    ...
    myImage.save('/Users/ernestocosta/tmp/testcoimage.jpg')
